  ...
  describe "account" do
    ...
    context "Credit Card" do
      before do
        ...
        @ofx_one_line = OFX::Parser::Base.new("spec/fixtures/creditcard_one_line.ofx")
        @parser = @ofx.parser
        @parser_one_line = @ofx_one_line.parser
        @account = @parser.account
        @account_one_line = @parser_one_line.account
      ...
      it "should return id" do
        ...
        @account_one_line.id.should == "XXXXXXXXXXXX1111"
      end

      it "should return currency" do
        @account.currency.should == "USD"
        @account_one_line.currency.should == "USD"
      end
    end
